...
social:
  GitHub: https://github.com/ningxzx
  weibo: http://weibo.com/u/5676293350
...
leancloud_visitors:
  enable: true
  app_id: ty5SxyqRD0FnsXwJAwOt3duV-gzGzoHsz
  app_key: 7vmTspaJ18HaL8SAvaTBS9gr
...
algolia_search:
  ...
  labels:
    ...
    hits_empty: "不好意思，你搜索的 ${query} 没有找到结果"
    hits_stats: "共找到${hits}条结果，这段时间，秒针朝前走了${time}步"
